    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "Lozinka ili korisničko ime nisu ispravni!");
                    return View(model);
            }
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.KorisničkoIme, Email = model.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    korisnik korisnik = new korisnik { idKorisnik = user.Id, registracijskiEmailKorisnik = model.Email, korisničkoImeKorisnik = user.UserName };
